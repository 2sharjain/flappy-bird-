...
def gameOver(score):
     ...
     canvas1.create_text(200,200,text="GAME OVER",fill="BLACK",font=("Comic San MS",50,"bold"))
     txt=canvas1.create_text(200,250,text="YOUR SCORE IS :"+str(score),fill="BLACK",font=("Comic San MS",25,"bold"))
     canvas1.pack()
     entry=Entry(root)
     entry.pack()
     ...
     def setName():
      ...
      for i in leaders:
          canvas1.create_text(200,y,text=(i+": "+str(leaders[i])),fill="BLACK",font=("Comic San MS",20,"bold"))
          y=y+50
      button2.pack_forget()
      entry.pack_forget()
